...
const appUrl = process.env.NEXT_PUBLIC_APP_URL ?? 'https://www.chicmagnolia.com';
...
console.log('The plaintext token is shown only in this output. Share it privately.');
