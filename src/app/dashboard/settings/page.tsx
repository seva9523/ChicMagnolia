...
export default async function SettingsPage({
  ...
  const fullName =
    String(user.user_metadata.full_name ?? '').trim() || 'Not provided';
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-6">
          ...
          <p className="text-muted-foreground mt-3 max-w-2xl">
            Review account details, download a portable copy of your data or
        ...
        <div className="mt-8 grid gap-6">
          ...
          <section className="bg-card rounded-3xl border p-6 shadow-sm sm:p-8">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              Download a JSON file containing your account profile, legal
              acceptance history, tracked purchases, price checks, notifications
              and non-sensitive subscription status. Card details and internal
              Stripe identifiers are not included.
            </p>
          ...
          <section className="bg-card rounded-3xl border border-red-200 p-6 shadow-sm sm:p-8">
            ...
            <p className="text-muted-foreground mt-3 text-sm">
              Billing providers may retain limited historical records where
              required for accounting, fraud prevention or legal obligations.
