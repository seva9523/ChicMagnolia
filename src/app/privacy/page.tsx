...
export const metadata: Metadata = {
  ...
  description: 'How ChicMagnolia uses and protects personal data during the private beta.',
};
  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          {LEGAL_OPERATOR_NAME} is the data controller for the personal data described in
          this notice. ChicMagnolia is currently operated as a private beta service from
          the United Kingdom.
        </p>
        <p>
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Account data:</strong> email address, name, account identifiers,
            authentication status and account dates.
          </li>
          <li>
            <strong>Purchase data:</strong> retailer, product name and URL, purchase price,
            purchase and return dates, saved size and colour, and tracking status.
          </li>
          <li>
            <strong>Monitoring data:</strong> price-check results, stock status, timestamps,
            errors and price-drop notification history.
          </li>
          <li>
            <strong>Billing data:</strong> subscription status, billing-period dates and
            Stripe customer or subscription references. ChicMagnolia does not receive or
          ...
          <li>
            <strong>Anonymous analytics:</strong> aggregated page-view information such as
            route, referrer, country, browser and device category. ChicMagnolia strips
            query strings before sending analytics events.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            tax, fraud-prevention or compliance records where the law requires it.
          </li>
        </ul>
        <p>
          ChicMagnolia does not sell personal data, use it for behavioural advertising or
          make solely automated decisions that have legal or similarly significant effects.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>GitHub Actions to initiate the protected daily-monitoring endpoint.</li>
        </ul>
        <p>
          Providers receive only the information needed for their role. Product URLs, saved
          variant details and technical request data may be processed by scraping providers
          when a retailer check runs. ChicMagnolia may also disclose information where
          required by law, to protect users or to investigate misuse.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Supabase authentication uses cookies that are necessary to keep you signed in and
          protect dashboard access. Vercel Web Analytics is configured for aggregated
          analytics, does not use advertising cookies and is not used to follow you across
          other websites. ChicMagnolia does not currently use marketing or behavioural
          advertising cookies.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>
            Account, purchase, monitoring and notification data is generally kept while the
          ...
          <li>
            Stripe and other providers may retain billing or compliance records under their
            own legal obligations even after the ChicMagnolia account is deleted.
          </li>
          <li>
            Backups and provider recovery systems may take a limited period to cycle out
            deleted data, during which it is not used for normal service activity.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Deleting an account removes the Supabase authentication user and cascades deletion
          through the user-owned ChicMagnolia profile, purchases, price checks, notifications
          and subscription-state record. If a Stripe customer is linked, ChicMagnolia first
      ...
      <section>
        ...
        <p>
          The current notice version is {PRIVACY_VERSION}. Material changes will be shown in
          the service or communicated before a new use of personal data begins. Earlier
          versions may be retained for accountability records.
        </p>
      </section>
    </LegalPage>
  );
