    ...
    <>
      <main className="min-h-screen px-6 py-10 sm:px-10">
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-9 leading-7 [&_a]:font-medium [&_a]:text-primary [&_a]:underline [&_h2]:text-2xl [&_h2]:font-semibold [&_h3]:text-lg [&_h3]:font-semibold [&_li]:ml-5 [&_li]:list-disc [&_p]:text-muted-foreground [&_ul]:space-y-2">
            {children}
          </div>
        </article>
      </main>
